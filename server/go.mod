...
require (
	...
	github.com/DHowett/go-plist v1.0.1 // indirect
	...
	github.com/phinexdaz/ipapk v0.0.0-20180706142810-91f3861dffcf // indirect
...
replace github.com/DHowett/go-plist => howett.net/plist v1.0.1
