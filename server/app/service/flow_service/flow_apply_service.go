...
// List 申请流程列表
func (service flowApplyService) List(page request.PageReq, listReq flow_schema.FlowApplyListReq) (res response.PageResp, e error) {
	// 分页信息
	limit := page.PageSize
	...
	result := []flow_schema.FlowApplyResp{}
...
// Edit 申请流程编辑
func (service flowApplyService) Edit(editReq flow_schema.FlowApplyEditReq) (e error) {
	var obj model.FlowApply
