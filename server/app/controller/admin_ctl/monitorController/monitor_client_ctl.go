...
func (hd *MonitorClientHandler) ErrorUsers(c *gin.Context) {
	var Req monitorSchema.MonitorClientDetailReq
...
func (hd *MonitorClientHandler) Del(c *gin.Context) {
	var delReq monitorSchema.MonitorClientDelReq
...
func (hd *MonitorClientHandler) DelBatch(c *gin.Context) {
	var delReq monitorSchema.MonitorClientDelBatchReq
	if response.IsFailWithResp(c, util.VerifyUtil.VerifyJSON(c, &delReq)) {
		return
	}
	if delReq.Ids == "" {
...
func (hd *MonitorClientHandler) ImportFile(c *gin.Context) {
	...
	defer file.Close()
	importList := []monitorSchema.MonitorClientResp{}
