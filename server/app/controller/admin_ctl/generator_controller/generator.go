...
// @Param			table_name		body		string							true	"表名"
// @Param			entity_name		body		string							true	"实体名称"
// @Param			table_comment	body		string							true	"表描述"
// @Param			author_name		body		string							false	"作者名称"
// @Param			remarks			body		string							false	"备注信息"
// @Param			gen_tpl			body		string							false	"生成模板方式: [crud=单表, tree=树表]"
// @Param			module_name		body		string							true	"模块名"
// @Param			function_name	body		string							true	"功能名"
// @Param			tree_primary	body		string							false	"树表主键"
// @Param			tree_parent		body		string							false	"树表父键"
// @Param			tree_name		body		string							false	"树表名称"
// @Param			sub_table_name	body		string							false	"子表名称"
// @Param			sub_table_fk	body		string							false	"子表外键"
