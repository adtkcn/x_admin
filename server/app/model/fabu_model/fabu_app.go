...
type FabuApp struct {
	...
	Version          string                `gorm:"type:varchar(64);not null;default:'';comment:'当前版本号'" json:"version"`
	VersionCode      int                   `gorm:"not null;default:0;comment:'当前版本code'" json:"version_code"`
	...
	CurrentVersionId string                `gorm:"type:char(36);not null;default:'';comment:'当前发布版本id'" json:"current_version_id"`
