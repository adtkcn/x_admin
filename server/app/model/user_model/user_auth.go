...
type UserAuth struct {
	...
	UserID       string                `gorm:"type:char(36);not null;index;comment:'用户ID'" json:"user_id"`
	IdentityType string                `gorm:"type:varchar(20);not null;comment:'认证类型: phone/wechat_mini/wechat_mp/wechat_app/qq'" json:"identity_type"`
