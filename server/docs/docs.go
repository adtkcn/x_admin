            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "成功",
                        "schema": {
                            "$ref": "#/definitions/monitor_web.MonitorWebResp"
                        }
                    }
                }
            }
        },
        "/api/admin/monitor_web/edit": {
            "post": {
                "produces": [
                    "application/json"
                ],
