...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '流程历史' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of x_flow_history
-- ----------------------------
INSERT INTO `x_flow_history` VALUES (1, 1, 3, 1, 'admin', 0, '', 'Gateway_9c32347', '{\"timerange73058\":[\"14:40:18\",\"15:40:18\"],\"textarea53158\":\"333\"}', 1, '', 1703227314, 1703227314, 0);
INSERT INTO `x_flow_history` VALUES (2, 1, 3, 1, 'admin', 0, '', 'Activity_1b66e34', '{\"timerange73058\":[\"14:40:18\",\"15:40:18\"],\"textarea53158\":\"333\"}', 1, '', 1703227314, 1703227314, 0);
INSERT INTO `x_flow_history` VALUES (3, 1, 3, 1, 'admin', 1, '', 'Activity_9afc160', '{\"timerange73058\":[\"14:40:18\",\"15:40:18\"],\"textarea53158\":\"333\"}', 1, '', 1703227314, 1703227314, 0);
...
-- ----------------------------
INSERT INTO `x_system_auth_admin` VALUES (1, 1, 3, 'admin', 'admin', '7ca7e19452aa2366068785be5c7ded35', '/image/20232911/27699a1e991e4ba1ba13ee6d45185db6.jpg', '0', 'HOEp0', 1, 1, 0, 0, '127.0.0.1', 1703229521, 1642321599, 1703229521, 0);
...
INSERT INTO `x_system_auth_menu` VALUES (779, 778, 'C', '审批历史(待改)', '', 0, 'flow_history:list', 'flow_history/index', 'flow/flow_history/index', '', '', 1, 1, 0, 1702309379, 1702309379);
...
CREATE TABLE `x_system_log_login`  (
  ...
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统登录日志表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `x_system_log_operate`  (
  ...
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统操作日志表' ROW_FORMAT = DYNAMIC;
