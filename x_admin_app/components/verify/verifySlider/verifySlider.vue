	...
	<view style="position: relative; touch-action: none; touch-action: pan-y">
		...
		<view v-if="type === '2'" class="verify-img-out" :style="{height: (parseInt(imgSize.height) + vSpace) + 'px'}">
			<view class="verify-img-panel" :style="{width: imgSize.width,
				...
				<img :src="backImgBase" style="width:100%;height:100%;display:block"></img>
			...
			<view class="verify-left-bar"
				...
				<view class="verify-move-block" @touchstart="start" @mousedown="start" @touchend="end" @touchmove="move"
					...
					<view v-if="type === '2'" class="verify-sub-block" :style="{'width':Math.floor(parseInt(imgSize.width)*47/310)+ 'px' ,
						...
						<img :src="blockBackImgBase" alt="" style="width:100%;height:100%;display:block"></img>
					</view>
				</view>
			</view>
		</view>
			...
			getPictrue() {
				...
				myRequest({
					...
					if (res.repCode == "0000") {
						...
						this.blockBackImgBase = 'data:image/png;base64,' + res.repData.jigsawImageBase64
