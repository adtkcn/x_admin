...
免费开源的 x_admin 通用前后端分离后台管理系统。遵循 MIT 开源许可协议；
<br>
...
- 审批流：基于`LogicFlow`和`FcDesigner`,整体流程待完善
